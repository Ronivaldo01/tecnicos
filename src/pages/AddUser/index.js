                ...
                <div className="wrapper">
                    <div className="row">
                        ...
                        <div className="top-content-adm">
                            <span className="title-content">Cadastrar Técnicos</span>
                            ...
                            <form onSubmit={addUser} className="form-adm">
                                ...
                                <div className="row-input">
                                    ...
                                    <div className="column">
                                        ...
                                        <input type="text" name="telefone" id="telefone" className="input-adm" placeholder="Seu Telefone" onChange={valueInput} />
                                    </div>
                                    ...
                                    <div className="column">
                                        ...
                                        <input type="text" name="endereco" id="endereco" className="input-adm" placeholder="Endereço" onChange={valueInput} />
                                    </div>
                                </div>
