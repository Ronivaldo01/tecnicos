                ...
                <div className="wrapper">
                    <div className="row">
                        <div className="top-content-adm">
                            <span className="title-content">Listar de Técnicos</span>
                        ...
                        <table className="table-list">
                            <thead className="list-head">
                                <tr>
                                    ...
                                    <th className="list-head-content table-sm-none">Endereço</th>
                            ...
                            <tbody className="list-body">
                                {data.map(user => (
                                    <tr key={user.id}>
                                        ...
                                        <td className="list-body-content table-sm-none">{user.telefone}</td>
                                        <td className="list-body-content table-sm-none">{user.email}</td>
                                        <td className="list-body-content">{user.endereco}</td>
