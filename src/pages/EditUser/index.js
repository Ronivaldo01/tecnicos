...
export const EditUser = (props) => {
    ...
    const editUser = async e => {
        ...
        await api.put("/user", { id, name, email,endereco,telefone }, headers)
            .then((response) => {
                setStatus({
                    type: 'redSuccess',
                            ...
                            <form onSubmit={editUser} className="form-adm">
                                ...
                                <div className="row-input">
                                    <div className="column">
                                        ...
                                        <input type="text" name="name" id="name" className="input-adm" placeholder="Nome completo do usuário" value={telefone} onChange={text => setTelefone(text.target.value)} />
                                    </div>
                                </div>
                                ...
                                <div className="row-input">
                                    ...
                                    <div className="column">
                                        <label className="title-input">Endereço</label>
                                        <input type="text" name="endereco" id="endereco" className="input-adm" placeholder="Endereço" value={endereco} onChange={text => setEndereco(text.target.value)} />
                                    </div>
